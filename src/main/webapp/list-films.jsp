...
<div class="container py-2 mb-4">
    <ul class="nav justify-content-center">
        <li class="nav-item">
            <a class="nav-link <c:out value="${genere==null?'active':''}"/>" href="list-films.jsp">Totes les
                categories</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <c:out value="${genere=='AVENTURES'?'active':''}"/>"
               href="list-films.jsp?genere=AVENTURES">Aventures</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <c:out value="${genere=='FICCIO'?'active':''}"/>" href="list-films.jsp?genere=FICCIO">Ciència
                ficció</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <c:out value="${genere=='DIBUIXOS'?'active':''}"/>"
               href="list-films.jsp?genere=DIBUIXOS">Dibuxos</a>
        </li>
        <li class="nav-item">
                            ...
                            <c:if test="${loop.index < NUM_FILM}">
                                <li class="media  my-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="py-0 my-0"><c:out value="${film.duration}"/></p>
                                    </div>
                                </li>
                            </c:if>
                        </c:forEach>
